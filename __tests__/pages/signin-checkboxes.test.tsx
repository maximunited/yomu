...
describe('SignIn Page Checkboxes', () => {
  ...
  describe('Checkbox Functionality', () => {
    test('should render both checkboxes with correct labels', () => {
      ...
      const saveEmailCheckbox = screen.getByRole('checkbox', { name: /save email/i });
      const keepSignedInCheckbox = screen.getByRole('checkbox', { name: /keep me signed in/i });
    ...
    test('should have proper styling classes', () => {
      ...
      expect(saveEmailCheckbox).toHaveClass('h-4', 'w-4', 'text-purple-600', 'focus:ring-purple-500', 'border-gray-300', 'rounded');
      expect(keepSignedInCheckbox).toHaveClass('h-4', 'w-4', 'text-purple-600', 'focus:ring-purple-500', 'border-gray-300', 'rounded');
    });
  ...
  describe('Checkbox Layout and Spacing', () => {
    test('should have proper spacing between checkboxes', () => {
      ...
      const checkboxContainer = screen.getByRole('checkbox', { name: /save email/i }).closest('div');
      const nextCheckboxContainer = screen.getByRole('checkbox', { name: /keep me signed in/i }).closest('div');
    ...
    test('should have proper alignment for checkbox and label', () => {
      ...
      const saveEmailContainer = screen.getByRole('checkbox', { name: /save email/i }).closest('div');
      const keepSignedInContainer = screen.getByRole('checkbox', { name: /keep me signed in/i }).closest('div');
      
      // Check that containers have proper flex alignment classes
      expect(saveEmailContainer).toHaveClass('flex', 'items-start', 'space-x-3');
      expect(keepSignedInContainer).toHaveClass('flex', 'items-start', 'space-x-3');
    });
  });
