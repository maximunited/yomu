...
if (fs.existsSync(signinPath)) {
  ...
  console.log(`✅ Keep Signed In checkbox: ${hasKeepSignedInCheckbox ? '✓' : '✗'}`);
  ...
  console.log(`✅ Save Email translation: ${hasSaveEmailTranslation ? '✓' : '✗'}`);
  console.log(`✅ Keep Signed In translation: ${hasKeepSignedInTranslation ? '✓' : '✗'}`);
...
if (fs.existsSync(translationsPath)) {
  ...
  console.log(`✅ Keep Signed In translation key: ${hasKeepSignedIn ? '✓' : '✗'}`);
