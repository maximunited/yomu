...
async function createDreamCardPartnerships() {
  try {
    ...
    if (dreamCardBrands.length === 0) {
      console.log('❌ No DREAM CARD brands found. Make sure to run the seed script first.');
      return;
    }
    ...
    console.log(`📊 All ${dreamCardBrands.length} DREAM CARD brands are now linked together`);
