    ...
    <div className={`min-h-screen transition-colors duration-300 ${
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <div className={`rounded-lg p-6 shadow-lg ${isDarkMode ? 'bg-gray-800' : 'bg-white'}`}>
              <div className="flex items-center mb-4">
                ...
                <h2 className={`text-2xl font-bold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>{t('mission')}</h2>
              </div>
            ...
            <div className={`rounded-lg p-6 shadow-lg ${isDarkMode ? 'bg-gray-800' : 'bg-white'}`}>
              <div className="flex items-center mb-4">
                ...
                <h2 className={`text-2xl font-bold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>{t('vision')}</h2>
              </div>
              <p className={isDarkMode ? 'text-gray-300' : 'text-gray-600'}>
                {t('visionDescription')}
              </p>
          ...
          {/* Team Section */}
          <div className={`rounded-lg p-8 shadow-lg mb-8 ${isDarkMode ? 'bg-gray-800' : 'bg-white'}`}>
            <div className="text-center mb-8">
              <div className="flex items-center justify-center mb-4">
                <Users className="w-8 h-8 text-orange-600 mr-3" />
                <h2 className={`text-2xl font-bold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>{t('team')}</h2>
              </div>
              <p className={isDarkMode ? 'text-gray-300' : 'text-gray-600'}>
