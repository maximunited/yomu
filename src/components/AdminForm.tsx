        ...
        <div className="mt-3">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {type === 'brand' ? (
              <>
                ...
                <div>
                  <label htmlFor="brand-logoUrl" className="block text-sm font-medium text-gray-700">Logo URL</label>
          <input
            id="brand-logoUrl"
            type="text"
            ...
            onChange={(e) => handleChange('logoUrl', e.target.value)}
                ...
                <div>
                  <label htmlFor="brand-website" className="block text-sm font-medium text-gray-700">Website</label>
          <input
            id="brand-website"
            type="url"
            ...
            onChange={(e) => handleChange('website', e.target.value)}
                ...
                <div>
                  <label htmlFor="brand-description" className="block text-sm font-medium text-gray-700">Description</label>
          <textarea
            ...
            onChange={(e) => handleChange('description', e.target.value)}
                ...
                <div>
                  <label htmlFor="brand-category" className="block text-sm font-medium text-gray-700">Category</label>
          <select
            id="brand-category"
            ...
            onChange={(e) => handleChange('category', e.target.value)}
                ...
                <div>
                  <label htmlFor="brand-actionUrl" className="block text-sm font-medium text-gray-700">Action URL</label>
                  <input
                    id="brand-actionUrl"
                    type="url"
                ...
                <div>
                  <label htmlFor="brand-actionType" className="block text-sm font-medium text-gray-700">Action Type</label>
                  <input
                    id="brand-actionType"
                    type="text"
                ...
                <div>
                  <label htmlFor="brand-actionLabel" className="block text-sm font-medium text-gray-700">Action Label</label>
                  <input
              ...
              <>
                <div>
                  <label htmlFor="benefit-brandId" className="block text-sm font-medium text-gray-700">Brand</label>
          <select
            id="benefit-brandId"
            ...
            onChange={(e) => handleChange('brandId', e.target.value)}
                ...
                <div>
                  <label htmlFor="benefit-title" className="block text-sm font-medium text-gray-700">Title</label>
          <input
            id="benefit-title"
            type="text"
            ...
            onChange={(e) => handleChange('title', e.target.value)}
                ...
                <div>
                  <label htmlFor="benefit-description" className="block text-sm font-medium text-gray-700">Description</label>
          <textarea
            ...
            onChange={(e) => handleChange('description', e.target.value)}
                ...
                <div>
                  <label htmlFor="benefit-terms" className="block text-sm font-medium text-gray-700">Terms & Conditions</label>
                  <textarea
                    id="benefit-terms"
                ...
                <div>
                  <label htmlFor="benefit-redemptionMethod" className="block text-sm font-medium text-gray-700">Redemption Method</label>
          <input
            ...
            onChange={(e) => handleChange('redemptionMethod', e.target.value)}
                ...
                <div>
                  <label htmlFor="benefit-promoCode" className="block text-sm font-medium text-gray-700">Promo Code</label>
                  <input
                ...
                <div>
                  <label htmlFor="benefit-url" className="block text-sm font-medium text-gray-700">URL</label>
                  <input
                    id="benefit-url"
                    type="url"
                ...
                <div>
                  <label htmlFor="benefit-validityType" className="block text-sm font-medium text-gray-700">Validity Type</label>
          <select
            ...
            onChange={(e) => handleChange('validityType', e.target.value)}
                ...
                <div>
                  <label htmlFor="benefit-validityDuration" className="block text-sm font-medium text-gray-700">Validity Duration (days)</label>
          <input
          ...
          <input
            ...
            onChange={(e) => handleChange('isFree', Boolean(e.target.checked))}
                  ...
                  />
                  <label htmlFor="benefit-isFree" className="ml-2 block text-sm text-gray-900">Free benefit</label>
                </div>
              </>
            )}
